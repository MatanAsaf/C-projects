/** 
 *  @file 		safeQueue.h
 *  @brief 		header file for API functions for manging multithreads safeQueue
 * 
...
typedef enum Queue_Result {
	QUEUE_SUCCESS,
	QUEUE_UNITIALIZED_ERROR,	/* Uninitialized Queue error */
	ITEM_UNITIALIZED_ERROR,		/* Uninitialized item error */
