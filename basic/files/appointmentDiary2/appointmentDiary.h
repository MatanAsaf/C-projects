...
typedef enum 
{
    ...
    REALLOC_FAILED,		/* If there is no more space available and the increse prossess has failed  */
    ...
    CREATE_FILE_FAILED	/* If there was an error when saving the diary into a file */
} ERRORS;
/*----------------------------------------------------------------------------*/
